export const BASE_URL = process.env.VUE_APP_BACKEND_DOMAIN || 'http://localhost:3000';
export const FILE_BASE_URL = process.env.VUE_APP_FILE_BASE_URL || 'http://localhost:3000';
